...
namespace MyDnsPackage
{
    public class MyDns
    {
        ...
        private readonly int local_port = 0;
        ...
        public static bool IsBindEndPoint(System.Net.IPAddress localip, int port)
        {
            ...
            try
            {
                s.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.ReuseAddress, true);  //SocketOptionName.ReuseAddress是关键（端口复用）
                s.Bind(ipe);
                return false;
            }
